...
const icons = {
  winner: (
    <svg xmlns="http://www.w3.org/2000/svg" className="winner-icon !h-[80%] !w-[80%]" width="80%" height="80%" viewBox="0 0 18 19">
      <g id="winner">
        <path
  ...
  loser: (
    <svg xmlns="http://www.w3.org/2000/svg" className="loser-icon !h-[80%] !w-[80%]" width="80%" height="80%" viewBox="0 0 18 19">
      <g id="timeout">
        <path
