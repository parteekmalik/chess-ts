...
function LoginFormContent({ className }: React.ComponentPropsWithoutRef<"div">) {
        ...
        <CardContent>
          <div className="grid gap-6">
            <div className="flex flex-col gap-4">
              {(["discord", "google"] as IconKeys[]).map((provider) => (
                <Button key={provider} variant="outline" className="w-full" onClick={() => signIn(provider, { callbackUrl })}>
                  {icons[provider]}
                  <span>
