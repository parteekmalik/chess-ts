...
import { airdropFactory, createTransaction, getBase58Decoder, lamports, signAndSendTransactionMessageWithSigners } from "gill";
import { getTransferSolInstruction } from "gill/programs";
import { TOKEN_2022_PROGRAM_ADDRESS, TOKEN_PROGRAM_ADDRESS } from "gill/programs/token";
import { toast } from "sonner";

import { useInvalidateCryptoQueries, useWalletUiSigner } from "@acme/chess-queries";
...
async function getTokenAccountsByOwner(rpc: SolanaClient["rpc"], { address, programId }: { address: Address; programId: Address }) {
  return await rpc
