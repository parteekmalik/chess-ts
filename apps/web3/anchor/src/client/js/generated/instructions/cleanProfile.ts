...
export const CLEAN_PROFILE_DISCRIMINATOR = new Uint8Array([
  200, 172, 74, 131, 246, 80, 72, 26,
]);

export function getCleanProfileDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    CLEAN_PROFILE_DISCRIMINATOR
  );
}
...
export type CleanProfileInstructionData = { discriminator: ReadonlyUint8Array };

export type CleanProfileInstructionDataArgs = {};

export function getCleanProfileInstructionDataEncoder(): FixedSizeEncoder<CleanProfileInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)]]),
    (value) => ({ ...value, discriminator: CLEAN_PROFILE_DISCRIMINATOR })
  );
}
...
export function getCleanProfileInstructionDataCodec(): FixedSizeCodec<
  CleanProfileInstructionDataArgs,
  CleanProfileInstructionData
> {
  return combineCodec(
    getCleanProfileInstructionDataEncoder(),
    getCleanProfileInstructionDataDecoder()
  );
}

export type CleanProfileAsyncInput<
...
export type ParsedCleanProfileInstruction<
  TProgram extends string = typeof WEB3_PROGRAM_ADDRESS,
...
export function parseCleanProfileInstruction<
