...
export const JOIN_CHESS_MATCH_DISCRIMINATOR = new Uint8Array([
  54, 143, 175, 160, 64, 21, 123, 211,
]);

export function getJoinChessMatchDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    JOIN_CHESS_MATCH_DISCRIMINATOR
  );
}
...
export type JoinChessMatchInstructionData = {
  discriminator: ReadonlyUint8Array;
};

export type JoinChessMatchInstructionDataArgs = {};
...
export function getJoinChessMatchInstructionDataEncoder(): FixedSizeEncoder<JoinChessMatchInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: JOIN_CHESS_MATCH_DISCRIMINATOR })
  );
}
...
export function getJoinChessMatchInstructionDataCodec(): FixedSizeCodec<
  JoinChessMatchInstructionDataArgs,
  JoinChessMatchInstructionData
> {
  return combineCodec(
    getJoinChessMatchInstructionDataEncoder(),
    getJoinChessMatchInstructionDataDecoder()
  );
}

export type JoinChessMatchAsyncInput<
...
>(
  input: JoinChessMatchAsyncInput<
    TAccountPayer,
    TAccountChessMatch,
    TAccountRegistry,
    TAccountPlayerProfile
...
export type JoinChessMatchInput<
  TAccountPayer extends string = string,
  TAccountChessMatch extends string = string,
  TAccountRegistry extends string = string,
  TAccountPlayerProfile extends string = string,
...
export type ParsedJoinChessMatchInstruction<
  TProgram extends string = typeof WEB3_PROGRAM_ADDRESS,
...
export function parseJoinChessMatchInstruction<
