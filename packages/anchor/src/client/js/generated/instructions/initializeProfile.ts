...
export interface InitializeProfileInstructionData {
  discriminator: ReadonlyUint8Array;
  name: string;
}

export interface InitializeProfileInstructionDataArgs {
  name: string;
}
...
export interface InitializeProfileAsyncInput<
...
export interface ParsedInitializeProfileInstruction<
  TProgram extends string = typeof WEB3_PROGRAM_ADDRESS,
