...
export const MAKE_MOVE_DISCRIMINATOR = new Uint8Array([78, 77, 152, 203, 222, 211, 208, 233]);
...
> = Instruction<TProgram> &
  ...
  InstructionWithAccounts<
    [
      ...
      TAccountOpponentProfile extends string ? WritableAccount<TAccountOpponentProfile> : TAccountOpponentProfile,
      TAccountSystemProgram extends string ? ReadonlyAccount<TAccountSystemProgram> : TAccountSystemProgram,
      ...TRemainingAccounts,
    ]
  >;

export interface MakeMoveInstructionData {
  discriminator: ReadonlyUint8Array;
  moveFenStr: string;
}

export interface MakeMoveInstructionDataArgs {
  moveFenStr: string;
}
...
export function getMakeMoveInstructionDataCodec(): Codec<MakeMoveInstructionDataArgs, MakeMoveInstructionData> {
  return combineCodec(getMakeMoveInstructionDataEncoder(), getMakeMoveInstructionDataDecoder());
}

export interface MakeMoveAsyncInput<
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getMakeMoveInstructionDataEncoder().encode(args as MakeMoveInstructionDataArgs),
...
export function getMakeMoveInstruction<
  ...
  TProgramAddress extends Address = typeof WEB3_PROGRAM_ADDRESS,
>(
  input: MakeMoveInput<TAccountPayer, TAccountChessMatch, TAccountRegistry, TAccountPlayerProfile, TAccountOpponentProfile, TAccountSystemProgram>,
  config?: { programAddress?: TProgramAddress },
): MakeMoveInstruction<
  TProgramAddress,
  TAccountPayer,
...
export interface ParsedMakeMoveInstruction<
  TProgram extends string = typeof WEB3_PROGRAM_ADDRESS,
...
export function parseMakeMoveInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
