...
export const CREATE_CHESS_MATCH_DISCRIMINATOR = new Uint8Array([151, 70, 109, 219, 177, 191, 236, 31]);

export function getCreateChessMatchDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(CREATE_CHESS_MATCH_DISCRIMINATOR);
}
...
export interface CreateChessMatchInstructionData {
...
export interface CreateChessMatchInstructionDataArgs {
...
export function getCreateChessMatchInstructionDataCodec(): FixedSizeCodec<CreateChessMatchInstructionDataArgs, CreateChessMatchInstructionData> {
  return combineCodec(getCreateChessMatchInstructionDataEncoder(), getCreateChessMatchInstructionDataDecoder());
}

export interface CreateChessMatchAsyncInput<
...
>(
  input: CreateChessMatchAsyncInput<TAccountPayer, TAccountChessMatch, TAccountRegistry, TAccountProfile, TAccountSystemProgram>,
  config?: { programAddress?: TProgramAddress },
): Promise<
  CreateChessMatchInstruction<TProgramAddress, TAccountPayer, TAccountChessMatch, TAccountRegistry, TAccountProfile, TAccountSystemProgram>
> {
  // Program address.
  ...
  const instruction = {
    ...
    programAddress,
    data: getCreateChessMatchInstructionDataEncoder().encode(args as CreateChessMatchInstructionDataArgs),
  } as CreateChessMatchInstruction<TProgramAddress, TAccountPayer, TAccountChessMatch, TAccountRegistry, TAccountProfile, TAccountSystemProgram>;

  return instruction;
}

export interface CreateChessMatchInput<
  TAccountPayer extends string = string,
  TAccountChessMatch extends string = string,
  TAccountRegistry extends string = string,
  TAccountProfile extends string = string,
...
export function getCreateChessMatchInstruction<
  ...
  TProgramAddress extends Address = typeof WEB3_PROGRAM_ADDRESS,
>(
  input: CreateChessMatchInput<TAccountPayer, TAccountChessMatch, TAccountRegistry, TAccountProfile, TAccountSystemProgram>,
  config?: { programAddress?: TProgramAddress },
): CreateChessMatchInstruction<TProgramAddress, TAccountPayer, TAccountChessMatch, TAccountRegistry, TAccountProfile, TAccountSystemProgram> {
  // Program address.
  const programAddress = config?.programAddress ?? WEB3_PROGRAM_ADDRESS;
...
export interface ParsedCreateChessMatchInstruction<
  TProgram extends string = typeof WEB3_PROGRAM_ADDRESS,
...
export function parseCreateChessMatchInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
