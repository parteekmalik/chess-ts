...
export const CHESS_MATCH_DISCRIMINATOR = new Uint8Array([
  72, 241, 122, 67, 252, 229, 79, 237,
]);
...
export type ChessMatchArgs = {
  ...
  abandonmentAt: OptionOrNullable<number | bigint>;
...
export function getChessMatchEncoder(): Encoder<ChessMatchArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ['abandonmentAt', getOptionEncoder(getI64Encoder())],
...
export function getChessMatchDecoder(): Decoder<ChessMatch> {
  return getStructDecoder([
    ...
    ['abandonmentAt', getOptionDecoder(getI64Decoder())],
...
): Account<ChessMatch, TAddress>;
export function decodeChessMatch<TAddress extends string = string>(
  encodedAccount: MaybeEncodedAccount<TAddress>
): MaybeAccount<ChessMatch, TAddress>;
export function decodeChessMatch<TAddress extends string = string>(
