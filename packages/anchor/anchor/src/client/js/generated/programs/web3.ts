...
import {
  type ParsedCleanProfileInstruction,
  type ParsedCloseChessMatchInstruction,
  type ParsedCreateChessMatchInstruction,
...
export const WEB3_PROGRAM_ADDRESS =
  '2yPLmwjdWoBuX5jca96tjfxGL2wAPNfHQEyCMAcABcyU' as Address<'2yPLmwjdWoBuX5jca96tjfxGL2wAPNfHQEyCMAcABcyU'>;
...
export function identifyWeb3Account(
  ...
  if (
    containsBytes(
      ...
      fixEncoderSize(getBytesEncoder(), 8).encode(
        new Uint8Array([72, 241, 122, 67, 252, 229, 79, 237])
      ),
      0
    )
  ) {
  ...
  if (
    containsBytes(
      data,
      fixEncoderSize(getBytesEncoder(), 8).encode(
        new Uint8Array([184, 101, 165, 188, 95, 63, 127, 188])
      ),
      0
    )
  ) {
  ...
  throw new Error(
    'The provided account could not be identified as a web3 account.'
  );
}
...
export function identifyWeb3Instruction(
  ...
  if (
    containsBytes(
      data,
      fixEncoderSize(getBytesEncoder(), 8).encode(
        new Uint8Array([200, 172, 74, 131, 246, 80, 72, 26])
      ),
      0
    )
  ) {
  ...
  if (
    containsBytes(
      data,
      fixEncoderSize(getBytesEncoder(), 8).encode(
        new Uint8Array([114, 13, 159, 131, 41, 71, 181, 151])
      ),
      0
    )
  ) {
  ...
  if (
    containsBytes(
      data,
      fixEncoderSize(getBytesEncoder(), 8).encode(
        new Uint8Array([151, 70, 109, 219, 177, 191, 236, 31])
      ),
      0
    )
  ) {
  ...
  if (
    containsBytes(
      data,
      fixEncoderSize(getBytesEncoder(), 8).encode(
        new Uint8Array([54, 143, 175, 160, 64, 21, 123, 211])
      ),
      0
    )
  ) {
  ...
  throw new Error(
    'The provided instruction could not be identified as a web3 instruction.'
  );
}

export type ParsedWeb3Instruction<
  TProgram extends string = '2yPLmwjdWoBuX5jca96tjfxGL2wAPNfHQEyCMAcABcyU',
> =
  | ({
